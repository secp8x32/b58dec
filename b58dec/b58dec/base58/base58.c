...
bool b58tobin(void* bin, size_t* binszp, const char* b58, size_t b58sz)
{
    ...
    b58_almostmaxint_t *outi = (b58_almostmaxint_t*)malloc(outisz * sizeof (b58_almostmaxint_t));
    b58_maxint_t t;
...
bool b58enc(unsigned char* b58, size_t* b58sz, const void* data, size_t binsz, uint8_t* buf)
{
...
////    uint8_t *buf = (uint8_t*)malloc((1 + datasz + 0x20) * sizeof (uint8_t));
